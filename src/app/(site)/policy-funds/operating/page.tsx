  ...
  return (
    <>
      ...
      <NumberedSection
        ...
        lead="중소기업 정책자금은 기업의 성장단계에 따라 6개 세부자금으로 나뉩니다. 업력·수출실적·자금 용도에 따라 신청할 수 있는 자금이 다르고, 한도와 금리도 자금마다 다릅니다."
      >
      ...
      <NumberedSection
        index={5}
        title="신청 절차와 유의사항"
        lead="중소기업 정책자금은 온라인으로 기업정보를 입력하는 것부터 시작합니다. 평가 단계마다 준비할 서류가 다르므로 신청 전에 융자제한 사유부터 확인합니다."
      >
