...
/**
 * 회사소개 그룹 콘텐츠 — 회사소개 · 회사연혁 · 업무절차.
 * 기존 사이트 본문을 바탕으로 하되 회사소개는 수치·솔루션·기관 정보를 보강했다.
 * 오시는길 페이지는 2026-08-26 대표 피드백으로 삭제했다 — 사무실이 마곡으로 이전해
 * 옛 가산(금천구) 기준 교통·주차 정보였고, 주소 안내는 푸터로 충분하다는 결정.
...
export const companyPage = {
  ...
  metaDescription:
    "(주)이지크레더블 회사소개 — 2019년 설립, 정책자금·유동성자금·성장 솔루션으로 중소기업의 자금 확보를 돕는 기업 금융 솔루션 회사. 함께하는 지원기관과 업무위탁사를 소개합니다.",
};
...
export const history: HistoryEntry[] = [
  ...
  // 2020.12 계약 당시 상호는 한창(주) — 2026-08-26 대표 지시로 현재 상호 엠피원(주)로 표기한다. 한창으로 되돌리지 말 것
  { date: "2020.12", year: "2020", partner: "엠피원(주)", description: "엠피원과의 계약을 통해 B2B 전자상거래 영업대행을 수행하고 있습니다. B2B 구매자금 한도 책정부터 실제 사용까지 고객사가 필요로 하는 부분들을 도와드리고 있습니다." },
