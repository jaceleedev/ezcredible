...
완료: 디자인 시스템(`/design-system` 쇼케이스 라우트, noindex) · 홈(`/`) · **정책자금 4페이지** · **유동성자금 3페이지**(팩토링·의료·전자어음) — 2026 수치 반영, 4폭 검증, 빌드 통과
다음 순서:
1. 성장 4페이지(기업신용평가·PG·VAN·기업인증) → 회사소개 4페이지(회사소개·연혁·업무절차·오시는길)
